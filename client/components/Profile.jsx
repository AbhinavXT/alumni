        ...
        <div className='profileComponentMain'>
            ...
            <div className='profileComponentFull'>
                ...
                <div className='px-2'>
                    ...
                    consequuntur dicta ipsam. Minus aliquam eius nobis vero ipsa voluptatem aut nihil omnis, 
            ...
            <div className='profileComponentFull'>
                ...
                <div className='text-red-500 px-2'>Add your basic information here</div>
            </div>
        </div>
    )
}
