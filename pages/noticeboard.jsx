...
const noticeboard = () => {
  return (
    <div className='flex justify-center gap-x-12'>
        <div>
            <div className='flex flex-col items-center justify-center gap-y-8 divide-y divide-gray-900 bg-gray-100 mx-auto my-6 px-8 py-8 rounded-md'>
                ...
                <div className='flex flex-col gap-y-4 items-center justify-center text-center pt-6'>
                    ...
                    <div>
                        <form action="submit" className='flex flex-col items-center justify-center gap-y-4'>
                            <input className="bg-gray-100 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Name" />
                            <input className="bg-gray-100 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email" />
                            <input className="bg-gray-100 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="batch" type="year" placeholder="Batch" />
