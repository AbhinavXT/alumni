...
const gallary = () => {
    ...
    return (
        <div className="gallaryMain">
            ...
            <div className="gallaryHeader">Old Memories</div>
            ...
            <div className="gallaryLike">
                <div className="gallaryLikeButton">
